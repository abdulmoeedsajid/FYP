        ...
        <div  class="col-12 col-lg-9 col-xl-7">
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
            <div class="card-body p-4 p-md-5">
              <h3 style="text-align: center;" class="mb-4 pb-2 pb-md-0 mb-md-5">Order Form</h3>
              ...
              <form  class="was-validated">
                ...
                <div class="row">
                  <div class="col-md-6 mb-4">
                    ...
                    <div class="form-outline">
                      <input type="text" id="Full Name" class="form-control form-control-lg form-control-sm" placeholder="Driver name" required />
                  ...
                  <div class="col-md-6 mb-4">
                    ...
                    <div class="form-outline">
                      <input type="file" id="Contact" class="form-control form-control-lg form-control-sm"   placeholder="Driver img"   required />
                ...
                <div class="row">
                  <div class="col-md-6 mb-4 pb-2">
                    ...
                    <div class="form-outline">
                      <input type="text" id="emailAddress" class="form-control form-control-lg form-control-sm" placeholder="Vehicle name" required />
                  ...
                  <div class="col-md-6 mb-4 pb-2">
                    ...
                    <div class="form-outline">
                      <input type="file" id="Moving Date" class="form-control form-control-lg form-control-sm" placeholder="Vehicle img" required />
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-12 mb-4 pb-2">
                        ...
                        <div class="form-outline">
                          <input type="text" id="Moving Date" class="form-control form-control-lg form-control-sm" placeholder="Shipping ID" required />
