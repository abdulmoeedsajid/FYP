        ...
        <div  class="col-12 col-lg-9 col-xl-7">
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
            <div class="card-body p-4 p-md-5">
              <h3 style="text-align: center;" class="mb-4 pb-2 pb-md-0 mb-md-5">Inspection remaimder</h3>
                  ...
                  <div class="col-md-6 mb-4 pb-2">
                      ...
                      <div class="col-md-6 mb-4 pb-2">   
                        ...
                        <div class="form-outline">
                            <input type="file" id="emailAddress" class="form-control form-control-lg form-control-sm" placeholder="Vehicle img" required />
        
                          </div>
      
                      </div>
                      <div class="col-md-6 mb-4 pb-2">
               <!-- insection tasks remain to enter here -->
                       
                        <select class="select form-control form-control-lg form-control-sm" required> 
                            <option value="">Select Inpection Task</option>
                            <option value="1">Engine Oil Change</option>  
                            <option value="2">Transmission Fluid Check</option>        
                            <option value="3">Brake System Inspection</option>
                            <option value="4"> Tire Rotation and Inspection</option>
                  ...
                  <div class="col-md-6 mb-4 pb-2">
                    ...
                    <div class="form-outline">
                      <input type="date" id="emailAddress" class="form-control form-control-lg form-control-sm" placeholder="Due date" required />
