...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            <nav style="background-color: #62c5a1;" class="navbar navbar-expand-lg  py-4 px-4">
...
<div class="container">
  <div style="padding: 10px; margin-top: 10px;" class="row">
    <div class="col-lg-6" >
      <h2 style="color: #4c6979;" class=" ms-5" ><b>Vehicle Inspection</b></h2>

    </div>
    <div class="col-lg-6 " >
      
      <a href="./viewInspection.php">   <button style="float: right;"   type="button" class="btn btn-info  text-white bg-primary "> View Inspection</button> </a>
        ...
        <div  class="col-12 col-lg-9 col-xl-7">
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
            <div class="card-body p-4 p-md-5">
              <h3 style="text-align: center;" class="mb-4 pb-2 pb-md-0 mb-md-5">Vehicle Inspection</h3>
              ...
              <form  class="was-validated">
                ...
                <div class="row">
                    <div class="col-md-6 mb-4 pb-2">
                        ...
                        <select class="select form-control form-control-lg form-control-sm" required> 
                          ...
                          <option value="1">Truck1</option>
                          <option value="2">Truck2</option>
                          <option value="3">Truck3</option>
                          <option value="4">Truck4</option>
                  ...
                  <div class="col-md-6 mb-4">
                    ...
                    <div class="form-outline">
                      <input type="text" id="Contact" class="form-control form-control-lg form-control-sm"   placeholder="Odometer"  required />
                  ...
                  <div class="col-md-12 mb-4">
                    ...
                    <div class="form-outline">
                      <input type="file" id="Contact" class="form-control form-control-lg form-control-sm"   placeholder="Vehicle image"  required />
                  ...
                  <div class="col-md-12 mb-4">
                    ...
                    <div class="form-outline">
                      <input type="datetime-local" id="Contact" class="form-control form-control-lg form-control-sm"   placeholder="Vehicle image"  required />
                ...
                <h3 style="text-align: center;" class="mb-4 pb-2 pb-md-0 mb-md-5">Items Checklist</h3>
            ...
            <div class="row">
              <div class="col-md-12 mb-4">
                ...
                <div class="form-outline">
                  <label for="Driver signature">Driver signature</label>
                  <input type="text" id="Sign" class="form-control form-control-lg form-control-sm"   placeholder="Type your name to sign"  required />
