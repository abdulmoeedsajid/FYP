...
<div class="container">
  <div style="padding: 10px; margin-top: 10px;" class="row">
    <div class="col-lg-6" >
      <h2 style="color: #4c6979;" class=" ms-5" ><b>Inspection</b></h2>

    </div>
    <div class="col-lg-6" >
      
      <a href="./Inspection.php">   <button  style="float: right;"  type="button" class="btn btn-info  text-white bg-primary"> <i class="fa-solid fa-plus me-1"></i>Start Inspection</button> </a>
              ...
              <table class="table caption-top ">
                  ...
                  <tbody>
                    <tr class="name">
                      ...
                      <td data-label="Submitted">12/3/2023 04:23</td>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Inspection list</h5>
        ...
        <div class="modal-footer">
          ...
          <!-- <button type="button" class="btn btn-primary">Save changes</button> -->
                ...
                <td data-label="Action"><div class="button-container">     <a href="./Inspection.php" class="btn btn-primary me-1">Edit</a><button type="button" class="btn btn-info text-white bg-primary">Delete</button></div></td>
