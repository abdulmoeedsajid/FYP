              ...
              <form  class="was-validated"  method="POST" enctype="multipart/form-data">
                ...
                <div  class="col-md-12 mb-4 pb-2">
                    <div class="form-outline">
                      <input type="file" id="Vehicle Liscence" class="form-control form-control-lg form-control-sm" placeholder="Image" name="profile"  required />
                    </div>
                  </div>
               ...
               <div class="form-outline">
                <input type="text" id="emailAddress" class="form-control form-control-lg form-control-sm" placeholder="Vehicle company" name="company" required />
                  ...
                  <div class="col-md-6 mb-4 pb-2">
                    ...
                    <div class="form-outline">
                      <input type="text" id="Moving Date" class="form-control form-control-lg form-control-sm" placeholder="Year of Manufacture" name="manufacture_year" required />
                  ...
                  <div class="col-md-6 mb-4 pb-2">
                    ...
                    <div class="form-outline">
                      <input type="text" id="Pickup Location" class="form-control form-control-lg form-control-sm" placeholder="Load Capacity" name="load" required />
                  ...
                  <div class="col-md-6 mb-4 pb-2">
                    <div class="form-outline">
                      ...
                      <input type="text" id="Drop off Location" class="form-control form-control-lg form-control-sm" placeholder="Model" name="model" required />
                    </div>
                  </div>
                  </div>
                  ...
                  <div style="margin: auto; display: block;" class="col-md-6 mb-4">
  
                <div class="form-outline">
                 <input type="text" id="Contact" class="form-control form-control-lg form-control-sm"   placeholder="Plate Number" name="plate"  required />
...
if (isset($_POST['Submit'])) {
    ...
    $manufacure = $_POST['manufacture_year'];
    $load= $_POST['load'];
    $model= $_POST['model'];
