        ...
        <div id="page-content-wrapper">
            ...
            <div class="container">
              <div style="padding: 10px; margin-top: 10px;" class="row">
                <div class="col-lg-6" >
                  <h2 style="color: #4c6979;" class=" ms-5" ><b>Platform services</b></h2>
            
                </div>
                <div class="col-lg-6" >
                  
                  <a href="./platformservice.php">   <button  style="float: right;"  type="button" class="btn btn-info  text-white bg-primary"> <i class="fa-solid fa-plus me-1"></i>Add platformservice</button> </a>
              ...
              <table class="table caption-top ">
                  ...
                  <thead>
                    <tr>
                      ...
                      <th scope="col">Maintainance image</th>
                      <th scope="col">Maintainance title</th>
                      <th scope="col">Description</th>
                      <th scope="col">Inspection image</th>
                      <th scope="col">Inspection title</th>
                      <th scope="col">Description</th>
                      <th scope="col">Overall description</th>
                  ...
                  <tbody>
                    <tr>
                      <td data-label="Maintainance image"><img style="height: 40px;width: 50px;" src="./Images/maintain.jpg" alt=""></td>
                    
                      <td data-label="Maintainance title">Truck Maintenance Services</td>
                     
                      <td data-label="Description">Proper maintenance is essential to keep our car carrier fleet in top-notch condition. Preventive inspections are carried out to identify potential issues before they escalate into major problems.</td>
                    
                      <td data-label="Inspection image"><img style="height: 40px;width: 50px;" src="./Images/inspec.jpg" alt=""></td>
                     
                      <td data-label="Inspection title">Truck Inspection Services</td>
                    
                      <td data-label="Description">At Fleet track, we prioritize the safety and reliability of our car carrier fleet. Our truck inspection services are designed to ensure that each vehicle in our fleet meets the standards of safety and compliance.</td>

                      <td data-label="Overall Description">We help to manage the car haulers, ensuring that the vehicles are maintained and serviced properly. Our comprehensive truck inspection and maintenance services are designed to keep your vehicles running at their best, delivering vehicles on time, every time. Our preventive maintenance tasks, such as oil changes and , brake checks, enhance your fleet's performance and longevity.</td>
