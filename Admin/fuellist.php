        ...
        <div id="page-content-wrapper">
            ...
            <div class="container">
              <div style="padding: 10px; margin-top: 10px;" class="row">
                <div class="col-lg-6" >
                  <h2 style="color: #4c6979;" class=" ms-5" ><b>Fuel</b></h2>
            
                </div>
                <div class="col-lg-6" >
                  
                  <a href="./addfuel.php">   <button  style="float: right;"  type="button" class="btn btn-info  text-white bg-primary"> <i class="fa-solid fa-plus me-1"></i>Add Fuel</button> </a>
              ...
              <table class="table caption-top ">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td data-label="Name">Toyota</td>
                      <td data-label="Date">12/3/2023 03:33</td>
                      <td data-label="Price">$30</td>
                      <td data-label="Odometer">200km</td>
                      <td data-label="Liters">6</td>
                      <td data-label="Vendor">Shell</td>
                      
                     
                      <td data-label="Action"><div class="button-container"><a href="./addfuel.php"><button type="button" class="btn btn-info me-1">Edit</button></a><button type="button" class="btn btn-info me-1">Delete</button></div></td>
