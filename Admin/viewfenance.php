...
<div class="container">
  <div style="padding: 10px; margin-top: 10px;" class="row">
    <div class="col-lg-6" >
      <h2 class=" ms-5" ><b>Expense</b></h2>

    </div>
    <div class="col-lg-6" >
      
      <a href="./finance.php">   <button style="margin-left: 200px;"  type="button" class="btn btn-info  text-white bg-primary"> <i class="fa-solid fa-plus me-1"></i>Add Expense</button> </a>
              ...
              <table class="table caption-top ">
                  ...
                  <thead>
                    <tr>
                      ...
                      <!-- <th scope="col">Document/Photo</th>
                      -->
                  ...
                  <tbody>
                    <tr class="name">
                      <td data-label="Expense ID">1</td>
                      <td data-label="Vehicle name">Toyota</td>
                      <td data-label="Image"><img style="height: 40px;width: 50px;" src="./Images/t1.jpg" alt=""></td>
                     
                      <td data-label="Vendor">LMS</td>
                      
                      <td data-label="Expense type">Tool</td>
                     
                      <td data-label="Date">12/3/2023</td>
                      <td data-label="Notes">abc</td>
                      <td data-label="Amount">$20</td>
                      <!-- <td data-label="Document/Photo">abc</td>
                       -->
                     
                      <td data-label="Action"><div class="button-container"><a href="./finance.php"><button  type="button" class="btn btn-info me-1 text-white bg-primary">Edit</button></a><button type="button" class="btn btn-info text-white bg-primary">Delete</button></div></td>
