...
<div class="container">
  <div style="padding: 10px; margin-top: 10px;" class="row">
    ...
    <div class="col-lg-6 " >
      ...
      <a href="./viewInspection.php">   <button style="float: right;"   type="button" class="btn btn-info  text-white bg-primary "> View Platform services</button> </a>
        ...
        <div  class="col-12 col-lg-9 col-xl-7">
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
            <div class="card-body p-4 p-md-5">
              <h3 style="text-align: center;" class="mb-4 pb-2 pb-md-0 mb-md-5">Platform services form</h3>
  
              
              <form  class="was-validated">
  
                <h3 style="text-align: center;" class="mb-4 pb-2 pb-md-0 mb-md-5">Maintainance</h3>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-4">
                    ...
                    <div class="form-outline">
                      <input type="text" id="Contact" class="form-control form-control-lg form-control-sm"   placeholder="title"  required />
                  ...
                  <div class="col-md-12 mb-4">
                    ...
                    <div class="form-outline">
                      <input type="text" id="Contact" class="form-control form-control-lg form-control-sm"   placeholder="Description"  required />
                ...
                <h3 style="text-align: center;" class="mb-4 pb-2 pb-md-0 mb-md-5">Inspection</h3>
                ...
                <h3 style="text-align: center;" class="mb-4 pb-2 pb-md-0 mb-md-5">Overall discription</h3>
