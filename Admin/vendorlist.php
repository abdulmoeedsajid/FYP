...
<div class="container">
  <div style="padding: 10px; margin-top: 10px;" class="row">
    <div class="col-lg-6" >
      <h2 class=" ms-5" ><b>Vendors</b></h2>

    </div>
    <div class="col-lg-6" >
      
      <a href="./addVendors.php">   <button style="margin-left: 200px;"  type="button" class="btn btn-info  text-white bg-primary"> <i class="fa-solid fa-plus me-1"></i>Add Vendor</button> </a>
              ...
              <table class="table caption-top ">
                  ...
                  <tbody>
                    <tr class="name">
                      ...
                      <td data-label="Name">Chevron</td>
                      <td data-label="Type">fuel</td>
                     
                      <td data-label="Contact">03001202101</td>
                      <td data-label="Address">3200 6th ave S Birmingham US</td>
                      <td data-label="Email">contact@gmail.com</td>
                      <td data-label="Notes">abc</td>
                      
                     
                      <td data-label="Action"><div class="button-container"><a href="./addVendors.php"><button  type="button" class="btn btn-info me-1 text-white bg-primary">Edit</button></a><button type="button" class="btn btn-info text-white bg-primary">Delete</button></div></td>
