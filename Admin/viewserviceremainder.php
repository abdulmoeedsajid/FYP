...
<div class="container">
  <div style="padding: 10px; margin-top: 10px;" class="row">
    <div class="col-lg-6" >
      <h2 class=" ms-5" ><b>Remainder</b></h2>

    </div>
    <div class="col-lg-6" >
      
      <a href="./serviceremainder.php">   <button style="margin-left: 200px;"  type="button" class="btn btn-info  text-white bg-primary"> <i class="fa-solid fa-plus me-1"></i>Add Remainder</button> </a>
              ...
              <table class="table caption-top ">
                  ...
                  <tbody>
                    <tr class="name">
                      ...
                      <td data-label="Service task">Engine oil change</td>
                      <td data-label="Next due">23/8/2023</td>
                      <td data-label="Notes">abc</td>
                      <td data-label="Status"><button type="button" class="btn btn-info me-1 text-white bg-danger">Overdue</button></td>
                    
                      <td data-label="Action"><div class="button-container"><a href="./serviceremainder.php"><button  type="button" class="btn btn-info me-1 text-white bg-primary">Edit</button></a><button type="button" class="btn btn-info text-white bg-primary">Delete</button></div></td>
                    ...
                    <tr class="name">
                      ...
                      <tr class="name">
                        ...
                        <td data-label="Name">abc</td>
                        <td data-label="Service task">Engine oil change</td>
                        <td data-label="Next due">23/10/2023</td>
                        <td data-label="Notes">abc</td>
                        <td data-label="Status"><button type="button" class="btn btn-info me-1 text-white bg-danger">Overdue</button></td>
                      ...
                      <tr class="name">
                        ...
                        <td data-label="Name">abc</td>
                        <td data-label="Service task">Tire rotation</td>
                        <td data-label="Next due">23/9/2023</td>
                        <td data-label="Notes">abc</td>
                        <td data-label="Status"><button type="button" class="btn btn-info me-1 text-white bg-warning">due soon</button></td>
