        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 style="color: #5d8296;" class="fs-2 m-0">Dashboard</h2>
                </div>
            ...
            <div class="container">
              <div style="padding: 10px; margin-top: 10px;" class="row">
                <div class="col-lg-6" >
                  <h2 style="color: #5d8296;" class=" ms-5" ><b>Equipment assignments</b></h2>
            
                </div>
                <div class="col-lg-6" >
                  
                  <a href="./assignequipment.php">   <button style="margin-left: 200px;"  type="button" class="btn btn-info  text-white bg-primary"> <i class="fa-solid fa-plus me-1"></i>Assign Equipment</button> </a>
              ...
              <table class="table caption-top ">
                  ...
                  <tbody>
                    <tr  class="name">
                      ...
                      <td data-label="Equipment">PortableBlower</td>
                      <td data-label="Assigned driver">Joe</td>
                      <td data-label="Starting time">24/08/2023 04:57</td>
                      <td data-label="Ending time">24/08/2023 05:57</td>
