        ...
        <div id="page-content-wrapper">
            ...
            <div class="container">
              <div style="padding: 10px; margin-top: 10px;" class="row">
                <div class="col-lg-6" >
                  <h2 style="color: #4c6979;" class=" ms-5" ><b>Vehicles</b></h2>
            
                </div>
                <div class="col-lg-6" >
                  
                  <a href="./addtruck.php">   <button  style="float: right;"  type="button" class="btn btn-info  text-white bg-primary"> <i class="fa-solid fa-plus me-1"></i>Add Vehicle</button> </a>
              ...
              <table class="table caption-top ">
                  ...
                  <tbody>
                    <tr  class="name">
                      ...
                      <td data-label="plate number">abc</td>
                      <td data-label="vehicle company">abc</td>
                      <td data-label="manufacture year">1/2/2023</td>
                      <td data-label="load capacity">Abc</td>
                      <td data-label="model">abc</td>
                     
                      <td data-label="Action"><div class="button-container"><button type="button" class="btn btn-info me-1">Details</button></div></td>
