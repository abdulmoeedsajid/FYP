...
<!-- 
  ...
  <section class="gradient-custom">
        ...
        <div  class="col-12 col-lg-9 col-xl-7">
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
            <div class="card-body p-4 p-md-5">
              <h3 style="text-align: center;" class="mb-4 pb-2 pb-md-0 mb-md-5">Add Expense</h3>
   ...
   <!-- use vehicle name and  id for this purpose -->
                  ...
                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
                      <input type="file" id="emailAddress" class="form-control form-control-lg form-control-sm" placeholder="img" required />
                  ...
                  <div class="col-md-6 mb-4 pb-2">
                    ...
                    <select class="select form-control form-control-lg form-control-sm" required> 
                      ...
                      <option value="2">Toll</option>
                      <option value="3">Repairs and Breakdowns</option>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-4 pb-2">
                    ...
                    <div class="form-outline">
                      <input type="date" id="emailAddress" class="form-control form-control-lg form-control-sm" placeholder="date" required />
                  ...
                  <div class="col-md-6 mb-4 pb-2">
                    ...
                    <div class="form-outline">
                      <input type="text" id="emailAddress" class="form-control form-control-lg form-control-sm" placeholder="Amount" required />
