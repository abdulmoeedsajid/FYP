        ...
        <div id="page-content-wrapper">
            ...
            <div class="container">
              <div style="padding: 10px; margin-top: 10px;" class="row">
                <div class="col-lg-6" >
                  <h2 style="color: #4c6979;" class=" ms-5" ><b>Drivers</b></h2>
            
                </div>
                <div class="col-lg-6" >
                  
                  <a href="./driverform.php">   <button  style="float: right;"  type="button" class="btn btn-info  text-white bg-primary"> <i class="fa-solid fa-plus me-1"></i>Add driver</button> </a>
              ...
              <table  class="table caption-top ">
                  ...
                  <tbody>
                    <tr  class="name">
                      ...
                      <td data-label="Image"><img style="height: 40px;width: 50px;" src="./Images/user1.png" alt=""></td>
                     
                      <td data-label="Fullname">Mark</td>
                      <td data-label="Contact">03000000095</td>
                      <td data-label="Age">30</td>
                      <td data-label="Liscence no">ABC</td>
                      <td data-label="Expiry date">1/1/2023</td>
                      <td data-label="Experience">abc</td>
                      <td data-label="Joining date">1/1/2023</td>
                      <td data-label="Reference">abc</td>
                      <td data-label="Qualification">abc</td>
                      <td data-label="Education">abc</td>
                      <td data-label="Experience">abc</td>

                      <td data-label="Address">ABC</td>
                      <td data-label="Action"><div class="button-container"><a href="./driverform.php"><button type="button" class="btn btn-info me-1">Edit</button></a><button type="button" class="btn btn-info">Delete</button></div></td>
                    ...
                    <tr  class="name">
                      ...
                      <td data-label="Address">ABC</td>
                      <td data-label="Action"><div class="button-container"><button type="button" class="btn btn-info me-1">Edit</button><button type="button" class="btn btn-info">Delete</button></div></td>
