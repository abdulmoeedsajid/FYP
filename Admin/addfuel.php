                      ...
                      <a href="./driver.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"> <i
                        ...
                        <a href="./Trucklist.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                          ...
                          <a href="./orderlist.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                            ...
                            <a href="./fuellist.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i class="fa-solid fa-gas-pump me-2"></i>fuel</a>
        ...
        <div  class="col-12 col-lg-9 col-xl-7">
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
            <div class="card-body p-4 p-md-5">
              <h3 style="text-align: center;" class="mb-4 pb-2 pb-md-0 mb-md-5">Add Fuel</h3>
              ...
              <form  class="was-validated">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-4">
                    ...
                    <div class="form-outline">
                      <input type="file" id="Full Name" class="form-control form-control-lg form-control-sm" placeholder="image" required />
                  ...
                  <div class="col-md-6 mb-4">
                    ...
                    <div class="form-outline">
                      <input type="datetime-local" id="Contact" class="form-control form-control-lg form-control-sm"   placeholder="Fuel entry date"  required />
                  ...
                  <div class="col-md-6 mb-4 pb-2">
                    ...
                    <div class="form-outline">
                      <input type="text" id="emailAddress" class="form-control form-control-lg form-control-sm" placeholder="Price" required />
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-4 pb-2">
                    ...
                    <div class="form-outline">
                      <input type="text" id="emailAddress" class="form-control form-control-lg form-control-sm" placeholder="Liters" required />
                ...
                <div class="row">
                  ...
                  <div   class="col-md-12 mb-4 pb-2">
                   ...
                   <select class="select form-control form-control-lg form-control-sm" required> 
                     ...
                     <option value="2">Shell1</option>
                     <option value="3">shell2</option>
                     <option value="4">shell3</option>
