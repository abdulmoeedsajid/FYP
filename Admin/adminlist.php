        ...
        <div id="page-content-wrapper">
            ...
            <div class="container">
              <div style="padding: 10px; margin-top: 10px;" class="row">
                <div class="col-lg-6" >
                  <h2 style="color: #4c6979;" class=" ms-5" ><b>Users</b></h2>
            
                </div>
                <div class="col-lg-6" >
                  
                  <a href="./addadmin.php">   <button  style="float: right;"  type="button" class="btn btn-info  text-white bg-primary"> <i class="fa-solid fa-plus me-1"></i>Add Users</button> </a>
        ...
        <div class=" col-sm-8 col-lg-11 col-md-8    ">
          ...
          <div >
              ...
              <table  class="table caption-top ">
                  <caption>
                      <h2 style="text-align: center;"><b>Admin list</b></h2>
                    </caption>
                  <thead>
                    <tr>
                      <th scope="col">ID</th>
                  ...
                  <tbody>
                    <tr class="name">
                      ...
                      <td data-label="Image"><img style="height: 30px;width: 30px;" src="./Images/user1.png" alt=""></td>
                      <td data-label="first name">mark</td>
                      <td data-label="last name">mark</td>
                      
                      
                      <td data-label="email">user@gmail.com</td>
                      <td data-label="contact">03004070095</td>
                     
                     
                      <td data-label="Action"> <div class="button-container"><a style="text-decoration: none;" href="./userprofile.php"><i style="color: black;font-size:30px" class="fa fa-eye me-1"></a></i><a href="./addadmin.php"><button type="button" class="btn btn-info me-1">Edit</button></a><button type="button" class="btn btn-info">Delete</button></div></td>
                    ...
                    <tr class="name">
                      ...
                      <td data-label="Action"> <div class="button-container"><a style="text-decoration: none;" href="./userprofile.php"><i style="color: black;font-size:30px" class="fa fa-eye me-1"></a></i><button type="button" class="btn btn-info me-1">Edit</button><button type="button" class="btn btn-info">Delete</button></div></td>
