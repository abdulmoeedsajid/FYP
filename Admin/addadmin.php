        ...
        <div  class="col-12 col-lg-9 col-xl-7">
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
            <div class="card-body p-4 p-md-5">
              <h3 style="text-align: center;" class="mb-4 pb-2 pb-md-0 mb-md-5">Admin Form</h3>
              ...
              <form  class="was-validated">
                ...
                <div class="row">
                  <div class="col-md-6 mb-4 pb-2">
                    ...
                    <div class="form-outline">
                      <input type="text" id="emailAddress" class="form-control form-control-lg form-control-sm" placeholder="First name" required />
                  ...
                  <div class="col-md-6 mb-4 pb-2">
                    ...
                    <div class="form-outline">
                      <input type="text" id="Moving Date" class="form-control form-control-lg form-control-sm" placeholder="Last name" required />
                ...
                <!-- <div class="col-md-6 mb-4 pb-2">
                  ...
                  <div class="col-md-6 mb-4 pb-2">
                    ...
                    <div class="form-outline">
                      <input type="text" id="Moving Date" class="form-control form-control-lg form-control-sm"  placeholder="0300-123-4567" pattern="[0-9]{4}-[0-9]{3}-[0-9]{4}"  required />
                  ...
                  <div class="col-md-6 mb-4 pb-2">
                    <div class="form-outline">
                      <input type="text" id="Vehicle Liscence" class="form-control form-control-lg form-control-sm" placeholder="Email" required />
                    </div>
                  </div>
                  ...
                  <div class="col-md-6 mb-4">
                    ...
                    <div class="form-outline">
                      <input type="email" id="Contact" class="form-control form-control-lg form-control-sm"   placeholder="Password"   required />
