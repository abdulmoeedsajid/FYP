...
<div class="container">
  <div style="padding: 10px; margin-top: 10px;" class="row">
    ...
    <div class="col-lg-6" >
      ...
      <a href="./inspectionremainder.php">   <button style="margin-left: 200px;"  type="button" class="btn btn-info  text-white bg-primary"> <i class="fa-solid fa-plus me-1"></i>Add Remainder</button> </a>
              ...
              <table class="table caption-top ">
                  ...
                  <thead>
                    <tr>
                      ...
                      <th scope="col">Inspection task</th>
                  ...
                  <tbody>
                    <tr class="name">
                      ...
                      <td data-label="Inpection task">Barke inspection</td>
                      ...
                      <td data-label="Action"><div class="button-container"><a href="./inspectionremainder.php"><button  type="button" class="btn btn-info me-1 text-white bg-primary">Edit</button></a><button type="button" class="btn btn-info text-white bg-primary">Delete</button></div></td>
