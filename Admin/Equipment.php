  ...
  <section class="gradient-custom">
        ...
        <div  class="col-12 col-lg-9 col-xl-7">
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
            <div class="card-body p-4 p-md-5">
              <h3 style="text-align: center;" class="mb-4 pb-2 pb-md-0 mb-md-5">Add Equipment</h3>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-4">
                    ...
                    <div class="form-outline">
                        <input type="text" id="emailAddress" class="form-control form-control-lg form-control-sm" placeholder="Equipment name" required />
                  ...
                  <div class="col-md-6 mb-4">
                    ...
                    <div class="form-outline">
                        <input type="text" id="emailAddress" class="form-control form-control-lg form-control-sm" placeholder="Brand" required />
   ...
   -->
                  ...
                  <div class="col-md-6 mb-4 pb-2">
                    ...
                    <div class="form-outline">
                      <input type="text" id="emailAddress" class="form-control form-control-lg form-control-sm" placeholder="Serial number" required />
               ...
               <div class="row">
                <div class="col-md-6 mb-4 pb-2">
                    ...
                    <div class="form-outline">
                      <input type="text" id="emailAddress" class="form-control form-control-lg form-control-sm" placeholder="Model" required />
                 ...
                 <div class="col-md-6 mb-4 pb-2">
                    ...
                    <div class="form-outline">
                      <input type="file" id="emailAddress" class="form-control form-control-lg form-control-sm" placeholder="Document" required />
