...
<section style="overflow-x: auto;" class="gradient-custom  ">
    <div class="container py-3  ">
      <div class="row justify-content-center ">
       ...
       <div style="position: relative;"  class="col-sm-12 col-md-12 col-lg-7 py-3 py-sm-12  ">
       
        <div   class="card">
         <img style=" display: block; margin: 0 auto;   border-radius: 50%; height: 200px;width: 200px;    position:relative; bottom:30px;  z-index:1;   " src="./Images/team-1.jpg" alt="">
     
      <div style="position: relative; z-index: 3;"   class="card-body">
        ...
        <div style="font-size:larger;color: #5d8296; margin-left: 50px;" class="row mb-5">
          <div class="col-sm-6 ">
            <p style="font-weight: bold;" class="mb-0">First Name :</p>
          </div>
          <div class="col-sm-6 ">
        ...
        <div style="font-size:larger;color: #5d8296; margin-left: 50px;" class="row mb-5">
          <div class="col-sm-6">
            <p style="font-weight: bold;" class="mb-0">Last Name :</p>
          </div>
          <div class="col-sm-6">
        ...
        <div style="font-size:larger;color: #5d8296; margin-left: 50px;" class="row mb-5">
          <div class="col-sm-6">
            <p style="font-weight: bold;" class="mb-0">Contact number :</p>
          </div>
          <div class="col-sm-6">
            <p class="text-muted mb-0" > 03003200023</p>
          </div>
        </div>
        <div style="font-size:larger;color: #5d8296; margin-left: 50px;" class="row mb-5">
          <div class="col-sm-6">
            <p style="font-weight: bold;" class="mb-0">Email:</p>
          </div>
          <div class="col-sm-6">
            <p class="text-muted mb-0" > jone.admin234@gmail.com</p>
          </div>
        </div>
        <div style="font-size:larger;color: #5d8296; margin-left: 50px;" class="row mb-5">
          <div class="col-sm-6">
            <p style="font-weight: bold;" class="mb-0">Password :</p>
          </div>
          <div class="col-sm-6">
            <p class="text-muted mb-0" > 345</p>
          </div>
        </div>
