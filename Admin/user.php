...
<section class="gradient-custom ">
    <div class="container py-3  ">
      <div class="row justify-content-center align-items-center">
        <div class=" col-sm-8 col-lg-11 col-md-8 p-4 p-md-5 p-lg-5  ">
  
          <div >

            <h2 style=" color: #5d8296; text-align: center; margin-bottom: 30px;"><b>List of users</b></h2>
              ...
              <table class="table caption-top ">
                  ...
                  <tbody>
                    <tr class="name">
                      ...
                      <td data-label="Firstname">Mark</td>
                      <td data-label="Lastname">Mark</td>
                      ...
                      <td data-label="Organization Name">ABC</td>
                      <td data-label="Fleet size">15</td>
                   ...
                   <tr class="name">
                    ...
                    <tr class="name">
                      ...
                      <td data-label="Firstname">Jhon</td>
                      <td data-label="Lastname">Mark</td>
                      <td data-label="Email">Contact@gmail.com</td>
                      <td data-label="Contact">03000000095</td>
                      <td data-label="Image"><img style="height: 30px;width: 30px;" src="./Images/user1.png" alt=""></td>
                      <td data-label="Organization Name">ABC</td>
                      <td data-label="Fleet size">15</td>
                      <td data-label="Action"><div class="button-container ms-1"><button type="button" class="btn btn-info me-1">Edit</button><button type="button" class="btn btn-info">Delete</button></div></td>
                    </tr>
                  </tbody>
                </table>
