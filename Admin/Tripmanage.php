...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
          <div class="sidebar-heading text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom"><img class="logo" src="./Images/fleet logo.PNG" style="height: 40px; width: 40px;" alt="">
            Fleettrack</div>
        ...
        <div  class="col-12 col-lg-9 col-xl-7">
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
            <div class="card-body p-4 p-md-5">
              <h3 style="text-align: center;" class="mb-4 pb-2 pb-md-0 mb-md-5">Truck Form</h3>
              ...
              <form  class="was-validated">
                ...
                <div class="row">
                  <div class="col-md-6 mb-4">
                    ...
                    <div class="form-outline">
                      <input type="text" id="Full Name" class="form-control form-control-lg form-control-sm" placeholder="Truck ID" required />
                  ...
                  <div class="col-md-6 mb-4">
                    ...
                    <div class="form-outline">
                      <input type="text" id="Contact" class="form-control form-control-lg form-control-sm"   placeholder="Plate Number"   required />
                ...
                <div class="row">
                  <div class="col-md-6 mb-4 pb-2">
                    ...
                    <div class="form-outline">
                      <input type="text" id="emailAddress" class="form-control form-control-lg form-control-sm" placeholder="Vehicle company" required />
                  ...
                  <div class="col-md-6 mb-4 pb-2">
                    ...
                    <div class="form-outline">
                      <input type="text" id="Moving Date" class="form-control form-control-lg form-control-sm" placeholder="Year of Manufacture" required />
                  ...
                  <div class="col-md-6 mb-4 pb-2">
                    ...
                    <div class="form-outline">
                      <input type="text" id="Pickup Location" class="form-control form-control-lg form-control-sm" placeholder="Load Capacity" required />
                  ...
                  <div class="col-md-6 mb-4 pb-2">
                    <div class="form-outline">
                      ...
                      <input type="text" id="Drop off Location" class="form-control form-control-lg form-control-sm" placeholder="Model" required />
                    </div>
                  </div>
                ...
                <div style="margin: auto; display: block;" class="col-md-6 mb-4 pb-2">
                    <div class="form-outline">
                      <input type="file" id="Vehicle Liscence" class="form-control form-control-lg form-control-sm" placeholder="Image" required />
                    </div>
                  </div>
...
<!--   
                  <div style="margin: auto; display: block;" class="col-md-6 mb-4 pb-2">
                    <div class="form-outline">
                      <input type="text" id="Vehicle Liscence" class="form-control form-control-lg form-control-sm" placeholder="Load Capacity" required />
                    </div>
                  </div>
                   -->
