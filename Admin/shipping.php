...
<div class="container">
  <div class="row">
    <div class="col-lg-12">
      <h2 style="text-align: center; color: #5d8296;"><b>Shipping</b></h2>

    </div>
  </div>
</div>
      <!-- User table -->
      <section class="gradient-custom  " style="overflow-x: auto;">
                  ...
                  <table class="table caption-top ">
                      ...
                      <thead>
                        <tr>
                          ...
                          <th scope="col">Vehicle Liscence</th>
                      ...
                      <tbody>
                        <tr class="name">
                          ...
                          <td data-label="Email">Contact@gmail.com</td>
                          <td data-label="Drop of location">ABC</td>
                          <td data-label="Pickup location">ABC</td>
                          <td data-label="Moving date">1/2/2023</td>
                          <td data-label="Model/Brand">ABC</td>
                          <td data-label="Manufacture year">2/3/2023</td>
                          <td data-label="Vehicle Liscence">ABC</td>
                          <td data-label="Plate no">123</td>
                          <td data-label="Instructions">ABC</td>
                          <td data-label="Status"><div class="button-container"><button style="height: 30px; font-size: x-small; width: 50px;" type="button" class="btn btn-primary btn">Edit</button><button style="height: 30px; font-size: x-small; width: 50px;" type="button" class="btn btn-primary btn ms-1">Delete</button></div></td>
