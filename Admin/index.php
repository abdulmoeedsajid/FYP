              ...
              <a href="./shipping.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                      ...
                      <a href="./userprofile.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                        ...
                        <a href="./adminlist.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i class="fa-solid fa-users me-2"></i>Users</a>
                          ...
                          <a href="./loginadmin.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i class="fa-sharp fa-solid fa-right-from-bracket me-2"></i>Logout</a>
    ...
    <div class="row justify-content-center align-items-center">
      <div class=" col-sm-8 col-lg-11 col-md-8 p-4 p-md-5 p-lg-5  ">
        ...
        <div >
          ...
          <h2  style="text-align: center; color: #5d8296; margin-bottom: 30px;"><b>List of user Quries</b></h2>
            ...
            <table class="table caption-top ">
                ...
                <tbody>
                  <tr class="name">
                    ...
                    <td data-label="City">abc</td>
                    <td data-label="Image"><img style="height: 30px;width: 30px;" src="./Images/user1.png" alt=""></td>
                    <td data-label="Query">ABC</td>
                    
                    <td data-label="Action"><!-- Button trigger modal -->
                            ...
                            <div class="modal-body">
                              <form>
                                ...
                                <div class="form-group">
                                  <label style="margin-right: 420px;"  for="message-text" class="col-form-label ">Reply</label>
                 ...
                 <tr class="name">
                  ...
                  <tr class="name">
                    <td data-label="ID">1</td>
                    <td data-label="Firstname">Joe</td>
