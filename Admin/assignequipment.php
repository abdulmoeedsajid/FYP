        ...
        <div  class="col-12 col-lg-9 col-xl-7">
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
            <div class="card-body p-4 p-md-5">
              <h3 style="text-align: center;" class="mb-4 pb-2 pb-md-0 mb-md-5">Assign Equipment</h3>
                ...
                <div class="row">
                  <div class="col-md-12 mb-4">
                    ...
                    <select class="select form-control form-control-lg form-control-sm" required> 
                      ...
                      <option value="1">PortableBlower</option>
                      <option value="2">PortableBlower</option>
                      <option value="3">PortableBlower</option>
                    ...
                    <div class="col-md-12 mb-4 pb-2">
                      ...
                      <div class="form-outline">
                          <label for="">Equipment Image</label>
                        <input type="file" id="emailAddress" class="form-control form-control-lg form-control-sm" placeholder="Images" required />
                  ...
                  <div class="col-md-6 mb-4">
                    ...
                    <div class="form-outline">
                        <input type="text" id="emailAddress" class="form-control form-control-lg form-control-sm" placeholder="Assigned driver" required />
   ...
   -->
                  ...
                  <div class="col-md-6 mb-4 pb-2">
                    <select class="select form-control form-control-lg form-control-sm" required> 
                        ...
                        <option value="1">Tire Inflator</option>
                        <option value="2">Air Compressor</option>
                        <option value="3">Battery Charger</option>
                        <option value="4">Electronics</option>
                        <option value="5">Blower</option>
               ...
               <div class="row">
                <div class="col-md-6 mb-4 pb-2">
                    ...
                    <div class="form-outline">
                      ...
                      <input type="datetime-local" id="emailAddress" class="form-control form-control-lg form-control-sm" placeholder="Starting time" required />
                  ...
                  <div class="col-md-6 mb-4 pb-2">
                    ...
                    <div class="form-outline">
                      ...
                      <input type="datetime-local" id="emailAddress" class="form-control form-control-lg form-control-sm" placeholder="Ending time" required />
                ...
                <div class="mt-4 pt-2 d-flex justify-content-center">
                  <!-- <input class="btn btn-secondary btn-lg me-2" type="submit" value="Cancel" />
                  -->
