    ...
    <div class="row d-flex justify-content-center align-items-center">
      <div class="col-12 col-md-8 col-lg-6 col-xl-5">
        <div class="card bg-white text-dark" style="border-radius: 1rem;">
          <div autocomplete="off"  class="card-body p-5 text-center was-validated">

            <div class="mb-4">

              <h2 class="fw-bold mb-2 text-uppercase">Login</h2>
              <p class="text-dark-50 mb-4">Please enter your email and password!</p>

              <form class="form-outline form-white mb-4">
               
                <input type="email" id="typeEmailX" class="form-control form-control-lg form-control-sm" placeholder="Email" required />
                
              </form>

              <form class="form-outline form-white mb-4">
               
                <input type="password" id="typePasswordX" class="form-control form-control-lg form-control-sm" placeholder="Password" required />
               
              </form>

              <p class="small mb-4"><a class="text-dark-50" href="/forgotpassword.php">Forgot password?</a></p>
