...
<div class="container-expand">
    <div class="ha" style="width: 100%; color: rgb(248, 249, 250);">
      <h1 style="padding-top: 50px; padding-bottom: 10px;  font-size: 60px; font-family: 'Times New Roman', Times, serif; font-style: italic;">Truck Fuel</h1>
      <div class="container-sm">
      <p style="text-align: justify;">Car carrier trucks cover extensive distances and transport valuable cars, fuel filling is a essential to ensure uninterrupted and efficient operation on the road. Drivers monitor the fuel levels and plan for timely refueling to avoid unexpected disruptions during transportation. Proper fuel filling ensures that the trucks have sufficient fuel to cover long distances without the risk of running out of gas during carriage. Careful fuel filling and consumption management assist in controlling fuel expenses  </div>
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-5 pb-4 pb-lg-0 h-100">
       <a href=""><img class="img-fluid w-100 " src="./Images/fuel.jpg" alt="" id="Filter"  onmousemove="document.getElementById('Filter').src='./Images/fuel4.jpg'"></a>
      </div>
      <div class="col-lg-7">
        <h6 class="text-primary text-uppercase font-weight-bold">Truck fuel filling</h6>
        <h1 class="mb-4">Fuel efficiency</h1>
        <p style="color: rgb(145, 141, 141);" class="mb-4">  Maintain optimal fuel levels, enhance fuel efficiency, to ensure that the trucks are always ready to tackle long-haul journeys with confidence and reliability. Well-filled tanks enable the trucks to operate at their best, reducing fuel consumption and overall operating costs. </p>
        <ul class="list-inline">
          <li><h6><i class="far fa-dot-circle text-primary mr-3 me-3"></i>Deliver cars timely</h6></li>
          
          <li><h6><i class="far fa-dot-circle text-primary mr-3  me-3"></i>Uninterrupted Transportation</h6></li>
      </ul>
