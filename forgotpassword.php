          ...
          <div autocomplete="off"  class="card-body p-5 text-center was-validated">
            ...
            <div class="mb-4">
              ...
              <form class="form-outline form-white mb-4">
                ...
                <input type="email" id="typeEmailX" class="form-control form-control-lg form-control-sm" required />
                
              </form>

              <form class="form-outline form-white mb-4">
                <label class="form-label" for="typePasswordX">Reset Password</label>
                <input type="password" id="typePasswordX" class="form-control form-control-lg form-control-sm" required />
