...
<div class="container-expand">
    <div class="ha" style="width: 100%; color: rgb(248, 249, 250);">
      <h1 style="padding-top: 50px; padding-bottom: 10px; font-size: 60px; font-family: 'Times New Roman', Times, serif; font-style: italic;">Brake oil</h1>
      <div class="container-sm">
      <p style="text-align: justify;">The brake oil transmitts the force from the brake pedal to the brake components, allowing the truck to slow down or come to a stop safely.  Over time, brake fluid can become contaminated with moisture and other impurities, leading to reduced braking performance and potential damage to the braking system. By changing brake oil on time maintain the integrity of the braking system, ensuring optimal braking performance. </p>
    </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-5 pb-4 pb-lg-0 h-100">
       <a href=""><img class="img-fluid w-100 " src="./Images/in2.jpg" alt="" id="Filter"  onmousemove="document.getElementById('Filter').src='./Images/boil.jpg'"></a>
      </div>
      <div class="col-lg-7">
        <h6 class="text-primary text-uppercase font-weight-bold">Brake oil change</h6>
        <h1 class="mb-4">Enhance Fuel Efficiency</h1>
        <p style="color: rgb(145, 141, 141);" class="mb-4"> Brake oil changing helps prevent brake issues, enhances safety, and ensures smooth and secure transportation of your valuable vehicles. Manage timely replacement of old and contaminated brake fluid with fresh and clean brake oil.</p>
