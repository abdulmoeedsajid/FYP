...
$insert="INSERT INTO `shipping form`(`id`, `full name`, `contact`, `email`, `drop off location`, `pickup location`, `moving date`, `model/brand`, `manufacture year`, `vehicle license`, `plate number`, `instructions`) VALUES ('','$fullname','$contact','$email','$dropoff','$pickup','$movingdate','$model','$manufacture','$license','$plateno','$instructions')";
