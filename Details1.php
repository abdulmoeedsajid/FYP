  ...
  <div class="container">
      <div class="row align-items-center">
          <div class="col-lg-5 pb-4 pb-lg-0">
              <img class="img-fluid w-100" src="./Images/inspec.jpg" alt="">
              
          </div>
          <div class="col-lg-7">
              <h6 class="text-primary text-uppercase font-weight-bold">Inspection</h6>
              <h1 class="mb-4">Truck Inspection Services</h1>
              <p style="color:rgb(145, 141, 141);" class="mb-4">At Fleet track, we prioritize the safety and reliability of our car carrier fleet. Our truck inspection services are designed to ensure that each vehicle in our fleet meets the standards of safety and compliance. </p>
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-5 pb-4 pb-lg-0 h-100">
        <img class="img-fluid w-100 " src="./Images/maintain.jpg" alt="">
      </div>
      <div class="col-lg-7">
        <h6 class="text-primary text-uppercase font-weight-bold">Maintainence</h6>
        <h1 class="mb-4">Truck Maintenance Services</h1>
        <p style="color: rgb(145, 141, 141);" class="mb-4"> Proper maintenance is essential to keep our car carrier fleet in top-notch condition. Preventive inspections are carried out to identify potential issues before they escalate into major problems. </p>
        <ul class="list-inline">
          <li><h6><i class="far fa-dot-circle text-primary mr-3 me-3"></i>Preventive Inspections</h6>
          <li><h6><i class="far fa-dot-circle text-primary mr-3  me-3"></i>Oil Changes</h6></li>
          <li><h6><i class="far fa-dot-circle text-primary mr-3  me-3"></i>Scheduled Maintenance Programs</h6></li>
      </ul>
...
<div style="margin-bottom: 25px;" class="container ">
  <div class="row">
    <div class="col-sm-12 col-md-12 col-lg-7"  >
      <h2 style="text-align: center; margin-bottom: 20px;" class="ce"> Truck Maintainance and Inspection </h2>
      <p  class="cc" >
        We help to manage the car haulers, ensuring that the vehicles are 
        maintained and serviced properly.
        Our comprehensive truck inspection and maintenance services are designed to keep your vehicles running at their best, delivering vehicles on time, every time. 
         Our preventive maintenance tasks, such as oil changes and , brake checks, enhance your fleet's performance and longevity.
    </p>
    </div>
