...
.hv {
  ...
  .hv:hover {
    box-shadow: 0 0 250px rgba(3, 3, 3, 0.2); 
  }
...
<div class="container-expand">
  <div class="ha" style="width: 100%; color: aliceblue;">
    <h1 style="padding-top: 45px;">About us</h1>
  </div>
</div>
...
<!-- Registration form and Conatact info -->
  ...
  <div style="margin-top: 25px; margin-bottom: 25px;  "class="container">
    <h2 class="ce"><center> Manage Fleet Operations efficiently</center> </h2>
    <div class="row">
        <div   class="col-sm-12 col-md-12 col-lg-6">
          ...
          <p  class="cc" >
              ...
              maintained and serviced properly.We provide hauling companies with a comprehensive platform to manage the fleet of trucks.We help to manage fuel consumption, and maintain schedules. The system provides alerts when 
              a vehicle is due for maintenance or requires repairs.  We ensure that trucks are serviced and maintained on a regular basis 
              reducing breakdowns and improving safety. By having better control over your car 
              hauler fleet and being able to track expenses, the money on fuel costs, maintenance 
              expenses, and other operational expenses can be saved. By having better control over your car 
              hauler fleet and being able to track expenses, the money on fuel costs, maintenance 
              expenses, and other operational expenses can be saved. By having better control over your car 
              hauler fleet and being able to track expenses, the money on fuel costs, maintenance 
              expenses, and other operational expenses can be saved.
          </p>
        ...
        <div  class="col-sm-12 col-md-12 col-lg-6">
          <!-- <img  id="chng" class=" ii" style="border-radius: 100% ;" src="./Images/2.jpg" onclick="document.getElementById('chng').src='./Images/3.jpg'" > -->
          
          <img  id="chng" class=" ii " style="border-radius: 100% ;" src="./Images/2.jpg" onmousemove="document.getElementById('chng').src='./Images/8.jpg'" >
        </div>
    </div>
  </div>
