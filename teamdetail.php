...
<div class="container-expand">
  <div class="ha" style="width: 100%; color: aliceblue;">
    <h1 style="padding-top: 45px;">Muhammad Haroon</h1>
  </div>
</div>
  ...
  <div style="margin-top: 25px; margin-bottom: 25px;  "class="container">
    ...
    <div class="row">
        ...
        <div    class="col-sm-12 col-md-12 col-lg-7">
          ...
          <h2  style=" text-align: center;">Front End Designer</h2>
            
          
          <p style="margin-bottom: 10px; margin-top: 50px; text-align: center;" class="card-title">Muhammad Haroon</p>
          ...
          <p style="margin-top: 30px;"  class="cc" >
        ...
        <div  class="col-sm-12 col-md-12 col-lg-5">
          ...
          <img  id="chng" class="  ii"  src="./Images/team.png"  >
        </div>
    </div>
  </div>
