...
<div class="container-expand">
  <div class="ha" style="width: 100%; color: aliceblue;">
    <h1 style="padding-top: 45px;">Drivers</h1>
  </div>
</div>
...
<div style="align-items: center; " class="container ">
    ...
    <div class="row team" >
      <div   class="col-sm-12 col-md-12 col-lg-4 py-3 py-sm-12  ">
        <div  class="card">
          <a href="./driverdetails1.php"><img class="card-img-top" src="./Images/team-1.jpg" alt="Card image cap"></a>
          <div style="text-align: center;" class="card-body">
            <a style="text-decoration: none;" href="./driverdetails1.php"><h5 style="color: black;" class="card-title">Driver name</h5></a>
            <p class="card-text"></i>Age</p>
            <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandaedolor sit amet consectetur adipisicing elit. Repudiandae laudantium sint aspernatur, quam culpa voluptatum.</p>
           
            <a href="./driverdetails1.php" class="btn btn-primary" style="margin-left: 10px; ">View details</a>
...
<!-- <div style="align-items: center; " class="container ">
  ...
  <div class="ourcolor mt-5 mb-3">
    <h1 class="d-flex justify-content-center" style="color: #0575ba; padding-top: 10px; padding-bottom: 10px;"> 
View Truck
    </h1>
  ...
  <div class="row team" >
    <div   class="col-sm-12 col-md-12 col-lg-4 py-3 py-sm-12  ">
      <div  class="card">
        <a href="./driverdetails1.php"><img class="card-img-top" src="./Images/truck1.jpg" alt="Card image cap"></a>
        <div style="text-align: center;" class="card-body">
          <a style="text-decoration: none;" href="./teamdetail.php"><h5 style="color: black;" class="card-title">Peterbilt 388 Car Carrier</h5></a>
    ...
    <div   class="col-sm-12 col-md-12 col-lg-4 py-3 py-sm-12  ">
      <div  class="card">
        <a href="./driverdetails1.php"><img class="card-img-top" src="./Images/truck2.jpg" alt="Card image cap"></a>
        <div style="text-align: center;" class="card-body">
          <a style="text-decoration: none;" href="./teamdetail.php"><h5 style="color: black;" class="card-title">Freightliner Cascadia</h5></a>
