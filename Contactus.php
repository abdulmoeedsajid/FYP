...
<div class="container-expand">
  <div class="ha" style="width: 100%; color: aliceblue;">
    <h1 style="padding-top: 45px;">Contact us</h1>
  </div>
</div>
...
<section class="gradient-custom">
  ...
  <div class="container py-3">
    <!-- <h3 style="padding-left: 5px;">Your Information</h3> -->
    <div style="padding-left: 70px;"  class="row justify-content-center align-items-center">
      
      
      <div class=" col-12 col-md-12 col-lg-6 " style="width: 20rem; height: 20rem; margin-bottom: 50px;">
        
          <h5><i class="fa-solid fa-envelope me-2"></i>Email</h5>
          
          <p >Conatact@gmail.com</p>
         <hr>
         <h5><i class="fa-solid fa-location-dot me-2"></i>Address</h5>
         <p>Comsats University Rd, off GT road،, Sahiwal,</p>
         <hr>
         <h5><i class="fa-solid fa-phone me-2"></i>Contact</h5>
         <p>+923000000045</p>

         <a href="./adminreply.php">
          <button  class="btn btn-primary btn-lg ms-5 mt-5" type="submit">Replies</button>
        </a>
        
      </div>

      
      <div  class="col-12 col-md-12 col-lg-6  was-validated">
            ...
            <form method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-6 mb-4">
                  ...
                  <div class="form-outline">
                    <input type="text" id="firstName" class="form-control form-control-lg form-control-sm" placeholder="First Name" name="firstname" required />
                ...
                <div class="col-md-6  mb-4">
                  ...
                  <div class="form-outline">
                    <input type="text" id="lastName" class="form-control form-control-lg form-control-sm" placeholder="Last Name" name="lastname" required />
              ...
              <div class="row">
                ...
                <div class="col-md-6  mb-4 pb-2">
                  ...
                  <div class="form-outline">
                    <input type="tel" id="phoneNumber" class="form-control form-control-lg form-control-sm"  placeholder="0300-123-4567" pattern="[0-9]{4}-[0-9]{3}-[0-9]{4}" name="contact" required />
                ...
                <div class="row">
                  ...
                  <div class="form">
                    ...
                    <textarea class="form-control col-sm-8 col-md-10 col-lg-12" id="message"  rows="5" placeholder="Enter your comments" name="comments" required></textarea>
                  </div>
