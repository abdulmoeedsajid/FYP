...
<div class="container-expand">
    <div class="ha" style="width: 100%; color: rgb(248, 249, 250);">
      <h1 style="padding-top: 50px; padding-bottom: 10px;  font-size: 60px; font-family: 'Times New Roman', Times, serif; font-style: italic;">Truck battery</h1>
      <div class="container-sm">
      <p style="text-align: justify;">Battery checking in car carrier trucks is a vital maintenance procedure that involves inspecting and assessing the health of the vehicle's battery system. As car carrier trucks extensively rely on their batteries to power various electrical components, such as lights, communication systems, we ensure the batteries are in optimal condition. During the battery checking process, the battery's physical condition and its voltage levels are examined.</div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-5 pb-4 pb-lg-0 h-100">
       <a href=""><img class="img-fluid w-100 " src="./Images/inn7.jpg" alt="" id="Filter"  onmousemove="document.getElementById('Filter').src='./Images/battery1.jpg'"></a>
      </div>
      <div class="col-lg-7">
        <h6 class="text-primary text-uppercase font-weight-bold">Truck battery checking</h6>
        <h1 class="mb-4">Battery Life Extension</h1>
        <p style="color: rgb(145, 141, 141);" class="mb-4">  The battery powers various electrical components in car carrier trucks. Checking the battery ensures that these components function properly, including lights, communication systems. By checking and maintaining battery timely prevent battery failure, reducing the need for costly battery replacements. </p>
