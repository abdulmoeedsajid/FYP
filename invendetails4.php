...
<div class="container-expand">
    <div class="ha" style="width: 100%; color: rgb(248, 249, 250);">
      <h1 style="padding-top: 50px; padding-bottom: 10px;  font-size: 60px; font-family: 'Times New Roman', Times, serif; font-style: italic;">Truck tires</h1>
      <div class="container-sm">
      <p style="text-align: justify;">The tires of trucks have great significance due to long-distance hauls, heavy loads, and various road conditions. By replacing old or damaged tires with new ones on proper time safety of vehicle on the road is ensured. Car carrier trucks frequently transport heavy loads, putting immense pressure on the tires. Fresh and properly inflated tires with sufficient load-carrying capacity ensure safe and stable transportation. </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-5 pb-4 pb-lg-0 h-100">
       <a href=""><img class="img-fluid w-100 " src="./Images/tire.jpg" alt="" id="Filter"  onmousemove="document.getElementById('Filter').src='./Images/tire2.jpg'"></a>
      </div>
      <div class="col-lg-7">
        <h6 class="text-primary text-uppercase font-weight-bold">Truck tire change</h6>
        <h1 class="mb-4">Enhance Vehicle Handling</h1>
        <p style="color: rgb(145, 141, 141);" class="mb-4"> By maintaining tire changes in car carrier trucks, achieve a safer, more efficient, and cost-effective transportation process, ensuring the timely and secure delivery of valuable vehicles to their destinations. </p>
        <ul class="list-inline">
          <li><h6><i class="far fa-dot-circle text-primary mr-3 me-3"></i>Preventing Blowouts</h6></li>
          
          <li><h6><i class="far fa-dot-circle text-primary mr-3  me-3"></i>Road Safety</h6></li>
      </ul>
