  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex" role="search">
        ...
        <a href="./table.php"   class="btn btn-primary me-2" type="submit"> pickup</a>
            ...
            <form autocomplete="off" class="was-validated" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-6 mb-4">
                  ...
                  <div class="form-outline">
                    <input type="text" required id="firstName" class="form-control form-control-lg form-control-sm" placeholder="First Name" name="firstname"/>
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-4 pb-2">
                  ...
                  <div class="form-outline">
                    <input type="text" id="phoneNumber" class="form-control form-control-lg form-control-sm"  placeholder="0300-123-4567" pattern="[0-9]{4}-[0-9]{3}-[0-9]{4}" name="contact" required />
                ...
                <div class="col-md-6 mb-4 pb-2">
                  <div class="form-outline">
                    <input type="file" id="Profile" class="form-control form-control-lg form-control-sm" placeholder="Profile" name="profile" required  />
                  </div>
                </div>
                <div class="col-md-6 mb-4 pb-2">
                  <div class="form-outline">
                    <input type="text" id="OrganizationName" class="form-control form-control-lg form-control-sm" placeholder="Organization Name" name="orgname" required />
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-4 pb-2">
                  ...
                  <select class="select form-control form-control-lg form-control-sm" name="asset" required> 
                    <option value="">Choose option</option>
                    <option value="1">Less than 5 assets</option>
                    <option value="2">10 assets</option>
                    <option value="3">15 assets</option>
                    <option value="4">more than 15 assets</option>
                ...
                <div class="col-md-6 mb-4 pb-2">
                  <div class="form-outline">
                    ...
                    <input type="password" id="Password" class="form-control form-control-lg form-control-sm" placeholder="Enter 8 characters" name="password" required />
                  </div>
                </div>
              </div>
