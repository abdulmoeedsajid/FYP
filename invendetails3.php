...
<div class="container-expand">
    <div class="ha" style="width: 100%; color: rgb(248, 249, 250);">
      <h1 style="padding-top: 50px; padding-bottom: 10px;  font-size: 60px; font-family: 'Times New Roman', Times, serif; font-style: italic;">Engine oil</h1>
      <div class="container-sm">
      <p style="text-align: justify;">The engine oil has important role in moving engines parts, reducing friction, and dissipating heat generated during operation. Regular engine oil changes are ensured to keep the engine running smoothly. Over time, oil breaks down and loses its ability to disperse heat effectively. Fresh oil ensures the engine stays within the optimal temperature range, preventing overheating and potential engine failure.</div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-5 pb-4 pb-lg-0 h-100">
       <a href=""><img class="img-fluid w-100 " src="./Images/in4.jpg" alt="" id="Filter"  onmousemove="document.getElementById('Filter').src='./Images/enoil.jpg'"></a>
      </div>
      <div class="col-lg-7">
        <h6 class="text-primary text-uppercase font-weight-bold">Engine oil change</h6>
        <h1 class="mb-4">Enhance Fuel Efficiency</h1>
        <p style="color: rgb(145, 141, 141);" class="mb-4"> Car carrier trucks are designed to carry valuable vehicles, making engine reliability crucial for safe and timely deliveries. Maintaining oil changes help maintain engine performance, ensuring smooth operation during transportation. </p>
