      ...
      <div class="col-12 col-lg-9 col-xl-7">
        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
          <div class="card-body p-4 p-md-5">
            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Payment Form</h3>
              ...
              <div class="row">
                <div class="col-md-6 mb-4">
                  ...
                  <div class="form-outline">
                    <input type="text" id="Full Name" class="form-control form-control-lg form-control-sm" placeholder="User Name" name="fullname" required />
                ...
                <div class="col-md-6 mb-4">
                  ...
                  <div class="form-outline">
                    <input type="email" id="Contact" class="form-control form-control-lg form-control-sm"   placeholder="Email" name="email"  required />
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-4 pb-2">
                      ...
                      <label for="fleet">Contact number</label>
                      <select class="select form-control form-control-lg form-control-sm" name="contact" required> 
                        <option value="">Choose option</option>
                        <option value="Easy paisa(03000014024)">Easy paisa(03000014024)</option>
                        <option value="Jazz cash(03000014024)">Jazz cash(03000014024)</option>
              ...
              <div class="row">
                <div class="col-md-12 mb-4 pb-2">
                    ...
                    <div class="form-outline">
                      ...
                      <input type="file" id="Pickup Location" class="form-control form-control-lg form-control-sm" placeholder="screenshot" name="profile" required />
...
// insert query
  ...
  //  $insert="INSERT INTO `registration`(`id`, `first name`, `last name`, `email`, `contact`, `user image`, `organization name`, `fleet size`, `password`) VALUES ('','$firstname','$lastname','$email','$contact','$filename','$orgname','$asset','$password')";
   $insert="INSERT INTO `online payment`(`id`, `user name`, `email`, `payment contact`, `payment screen shot`) VALUES ('','$fullname','$email','$contact','$filename')";
