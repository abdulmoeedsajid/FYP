...
<div class="container-expand">
  <div class="ha" style="width: 100%; color: aliceblue;">
    <h1 style="padding-top: 45px;">Vehicles</h1>
  </div>
</div>
...
View Truck
  ...
  <div class="row team" >
    <div   class="col-sm-12 col-md-12 col-lg-4 py-3 py-sm-12  ">
      <div  class="card">
        <a href=""><img class="card-img-top" src="./Images/truck1.jpg" alt="Card image cap"></a>
        <div style="text-align: center;" class="card-body">
          <a style="text-decoration: none;" href=""><h5 style="color: black;" class="card-title">Peterbilt 388 Car Carrier</h5></a>
    ...
    <div   class="col-sm-12 col-md-12 col-lg-4 py-3 py-sm-12  ">
      <div  class="card">
        <a href=""><img class="card-img-top" src="./Images/truck2.jpg" alt="Card image cap"></a>
        <div style="text-align: center;" class="card-body">
          <a style="text-decoration: none;" href=""><h5 style="color: black;" class="card-title">Freightliner Cascadia</h5></a>
  ...
  <div class="row team" >
    ...
    <div   class="col-sm-12 col-md-12 col-lg-4 py-3 py-sm-12  ">
      <div  class="card">
        <img class="card-img-top" src="./Images/truck2.jpg" alt="Card image cap">
        <div style="text-align: center;" class="card-body">
          <h5 style="color: black;" class="card-title">Freightliner Cascadia</h5>
