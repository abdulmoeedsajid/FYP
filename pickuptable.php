...
<section class="gradient-custom ">
  <div class="container py-3  ">
    <div class="row justify-content-center align-items-center">
      <div class=" col-sm-8 col-lg-8 col-md-8 p-4 p-md-5 p-lg-5  ">
            ...
            <table class="table caption-top ">
                ...
                <tbody>
                  <tr>
                    ...
                    <td data-label="Contact">030000045</td>
                    <td data-label="Email">Contact@gmail.com</td>
                    <td data-label="Pickup Location">address</td>
                    <td data-label="Moving Date">24/7/23</td>
                  </tr>
                  <tr>
                    <td data-label="Fullname">Mark</td>
                    <td data-label="Contact">030000045</td>
