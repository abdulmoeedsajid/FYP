...
<section class="gradient-custom">
  <div class="container py-3">
      ...
      <div class="col-12 col-lg-9 col-xl-7">
        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
          <div class="card-body p-4 p-md-5">
            <marquee behavior="" direction="">Full payment or advance payment</marquee>
            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Shipping Form</h3>
            ...
            <form  class="was-validated" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-4">
                  ...
                  <div class="form-outline">
                    <input type="text" id="Contact" class="form-control form-control-lg form-control-sm"   placeholder="0300-123-4567"  required name="contact"  />
              ...
              <div class="row">
                <div class="col-md-6 mb-4 pb-2">
                  ...
                  <div class="form-outline">
                    <input type="email" id="emailAddress" class="form-control form-control-lg form-control-sm" placeholder="Email" required name="email" />
                ...
                <div class="col-md-6 mb-4 pb-2">
                  ...
                  <div class="form-outline">
                    <input type="text" id="drop off location" class="form-control form-control-lg form-control-sm" placeholder="Drop off location" name="dropoff" required  />
                ...
                <div class="col-md-6 mb-4 pb-2">
                  <div class="form-outline">
                    ...
                    <input type="date" id="moving date" class="form-control form-control-lg form-control-sm" placeholder="Moving Date" name="moving" required  />
                  </div>
                </div>
                </div>
              ...
              <div class="row">
                <div class="col-md-6 mb-4 pb-2">
                  <div class="form-outline">
                    <input type="text" id="Model/Brand " class="form-control form-control-lg form-control-sm" placeholder="Model/Brand" required name="model/brand" />
                  </div>
                </div>

                <div class="col-md-6 mb-4 pb-2">
                  <div class="form-outline">
                    <input type="text" id="Manufacture year" class="form-control form-control-lg form-control-sm" placeholder="Manufacture year"  name="manufact" required />
                  </div>
                </div>
                </div>
                ...
                <div class="col-md-6 mb-4 pb-2">
                  <div class="form-outline">
                    <input type="text" id="Vehicle Liscence" class="form-control form-control-lg form-control-sm" placeholder="Vehicle Liscence" name="liscence" required  />
                  </div>
                </div>
                <div class="col-md-6 mb-4 pb-2">
                  <div class="form-outline">
                    <input type="text" id="Plate Number" class="form-control form-control-lg form-control-sm" placeholder="Plate Number" name="plate" required   />
                  </div>
                </div>
                </div>
                ...
                <div class="col-md-12 mb-4 pb-2">
                  <div class="form">
                    <label for="message">Any Instructions</label>
                    <textarea class="form-control col-sm-8 col-md-10 col-lg-12" id="inst"  rows="5" placeholder="Instructions about vehicle" name="inst" required  ></textarea>
                  </div>
                  </div>
    ...
    <div class="mt-4 pt-2 d-flex justify-content-center">
    <a href="./payment.php">
      <button  style="width: 640px; height: 50px; font-size: larger;" class="btn btn-primary me-2 " type="submit">Online payment</button>
    </a>
  </div>
...
if (isset($_POST['Submit'])) {
    ...
    $pickup = $_POST['pickup'];
    $movingdate = $_POST['moving'];
    $model = $_POST['model/brand'];
    $manufacture = $_POST['manufact'];
    $license = $_POST['liscence'];
    $plateno = $_POST['plate'];
...
// insert query
    ...
    // $insert = " INSERT INTO `registration`(`id`, `firstname`, `lastname`) VALUES
    ...
    $insert="INSERT INTO `shipp`(`id`, `full name`, `contact`, `email`, `dropoff location`, `pickup location`, `moving date`, `model`, `manufacture year`, `license`, `plate no`, `instructions`) VALUES ('','$fullname','$contact','$email','$dropoff','$pickup','$movingdate','$model','$manufacture','$license','$plateno','$instructions')";
