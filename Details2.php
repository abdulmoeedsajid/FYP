  ...
  <div class="container">
      <div class="row align-items-center">
          <div class="col-lg-5 pb-4 pb-lg-0">
              <img class="img-fluid w-100" src="./Images/op.png" alt="">
              
          </div>
          <div class="col-lg-7">
              <h6 class="text-primary text-uppercase font-weight-bold">Smooth Fleet Performance</h6>
              <h1 class="mb-4">Fleet operation Services</h1>
              <p style="color:rgb(145, 141, 141);" class="mb-4">At Fleet track, we ensure make your fleet operations smoother and more cost-effective. Our Efficient Fleet Operations Module is designed to optimize the performance and productivity of your car carrier fleet. </p>
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-5 pb-4 pb-lg-0 h-100">
        <img class="img-fluid w-100 " src="./Images/route.jpg" alt="">
      </div>
      <div class="col-lg-7">
        <h6 class="text-primary text-uppercase font-weight-bold">Route Planning</h6>
        <h1 class="mb-4">Cost effective route planning</h1>
        <p style="color: rgb(145, 141, 141);" class="mb-4">  By planning routes that minimize travel distance and fuel consumption, route planning significantly contributes to cost optimization. Reduce your operational expenses while maintaining high service quality. </p>
        <ul class="list-inline">
          <li><h6><i class="far fa-dot-circle text-primary mr-3 me-3"></i>Cost Optimization</h6>
          <li><h6><i class="far fa-dot-circle text-primary mr-3  me-3"></i>Enhance customer satisfaction</h6></li>
          <li><h6><i class="far fa-dot-circle text-primary mr-3  me-3"></i>Minimize delivery times</h6></li>
      </ul>
...
<div style="margin-bottom: 25px;" class="container ">
  <div class="row">
    <div class="col-sm-12 col-md-12 col-lg-7"  >
      <h2 style="text-align: center; margin-bottom: 20px;" class="ce">  Efficient Fleet Operations </h2>
      <p  class="cc" >
        The Efficient Fleet Operations Module is a powerful tool in our Car Carrier Fleet Management System that makes running your fleet smoother and more cost-effective. With reports and improvements keep your fleet at its best
    </p>
    </div>
